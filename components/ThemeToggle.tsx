...
const ThemeToggle: React.FC = () => {
  ...
  return (
    ...
    >
      <div 
        className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full shadow-sm flex items-center justify-center transition-transform duration-300 ease-[cubic-bezier(0.2,0.8,0.2,1)] ${
          isDark ? 'translate-x-5 bg-surface text-white' : 'translate-x-0 bg-white text-yellow-500'
        }`}
      >
        {isDark ? (
